...
export default function SheetsPage() {
  ...
  return (
    <div className="container mx-auto max-w-7xl" data-testid="sheets-page">
      <div className="mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-400">Hoja de cálculo de Google Sheets</p>
          </div>
          ...
          <Card className="backdrop-blur-xl bg-white/5 border-gray-700">
            <CardContent className="py-4">
              <p className="text-sm text-gray-400 text-center">
                Si la hoja no se visualiza correctamente, haz clic en "Abrir en Nueva Pestaña"
              </p>
            </CardContent>
          </Card>
        </div>
